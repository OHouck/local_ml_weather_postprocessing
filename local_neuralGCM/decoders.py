...
# THIS is the decoder that needs to be retrained
@gin.register
class LearnedPrimitiveToWeatherbenchDecoder(PrimitiveToWeatherbenchDecoder):
  ...
  def __init__(
      ...
      correction_transform_module: TransformModule, # might also need to be region specific
      nodal_mapping_module: MappingModule, # this is the learned bit to be updated to be region specific
