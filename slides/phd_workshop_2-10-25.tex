...
\begin{frame}{Research Question}
    \textbf{Main Question:} Can we improve weather forecasts for specific regions cases using a computationally cheap post-processing model?
    ...
    \begin{columns}[T]
        \begin{column}{0.7\textwidth}
            ...
            \begin{itemize}
                ...
                \item Examples: Fourcastnet (NVIDIA), Pangu-Weather (Huawei), GenCast (Google), Aurora (Microsoft)
            \end{itemize}
        \end{column}
...
\begin{frame}{Related Literature}
    ...
    \begin{itemize}
        \item Model Output Statistics (MOS): linear regression-based bias correction (Glahn \& Lowry 1972)
        \item Neural networks for ensemble post-processing (Rasp \& Lerch 2018)
        \item CNNs for gridded NWP bias correction (Han et al. 2021)
...
\begin{frame}{Post-Processing Framework}
    ...
    \begin{itemize}
        \item Original forecast fields (temperature, wind speed)
        \item Lead time (1, 5, or 9 days ahead)
        \item Day of year (captures seasonal patterns)
    \end{itemize}

    \vspace{0.3cm}
    \textbf{Training:}
    \begin{itemize}
        \item Ground truth: ERA5 reanalysis (best estimate of actual weather)
...
% \begin{frame}{Key Finding: Equator Distance}
%     \textbf{Original Forecast Error:}
%     \begin{itemize}
%         \item Temperature errors \textit{increase} with distance from equator
%         \item Effect strongest for longer lead times (9 days)
%     \end{itemize}

%     \vspace{0.3cm}
%     \textbf{Post-Processing Improvement:}
%     \begin{itemize}
%         \item Largest improvements \textit{near the equator}
%         \item Tropical regions benefit most from local correction
%     \end{itemize}

%     \vspace{0.3cm}
%     \textbf{Interpretation:}
%     \begin{itemize}
%         \item Tropical weather is more locally driven (convection)
%         \item Mid-latitude weather depends on larger-scale patterns (jet stream, fronts)
%         \item Local post-processing captures local biases better than global dynamics
%     \end{itemize}
% \end{frame}
...
% \begin{frame}{Key Finding: Terrain Effects}
%     \textbf{Standard Deviation of Orography (SDOR):}
%     \begin{itemize}
%         \item Measures elevation variability within a grid cell
%         \item High SDOR = mountainous terrain, coastlines
%     \end{itemize}

%     \vspace{0.3cm}
%     \textbf{Results:}
%     \begin{itemize}
%         \item Temperature: Original error and improvement relatively flat with SDOR
%         \item Wind speed: Original error \textit{increases} with SDOR, improvement also increases
%     \end{itemize}

%     \vspace{0.3cm}
%     \textbf{Interpretation:}
%     \begin{itemize}
%         \item Complex terrain creates local wind patterns that global models miss
%         \item Post-processing can learn these local terrain effects
%         \item Wind speed benefits more than temperature from local correction
%     \end{itemize}
% \end{frame}
...
\begin{frame}{Plan: Test How Forecast Errors Affect Wholesale Prices}
    \textbf{Data:}
    \begin{itemize}
