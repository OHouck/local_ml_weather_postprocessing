...
\begin{frame}{Previous Post-Processing Papers Focused on Narrow Geographic Areas or Use Expensive Models}
    \begin{itemize}
        ...
        \item Han 2021: show how CNNs can be used to correct IFS on Gridded ERA5 data over China
...
\begin{frame}{Version 0: Damage Weighted MSE Loss Function}
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{mortal_errors_fig.png}
        \caption*{\small Mortality errors figure}
    \end{figure}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{figure}
                ...
                \caption*{\small Extreme heat trained model}
            \end{figure}
        \end{column}
        \begin{column}{0.48\textwidth}
            \vspace{0.5cm}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth]{pangu/lead_time/multi_region/6x6/leadtime_rmse_improvement_2m_temperature_trainedwith_2m_temperature_geographic_pangu_extreme_heat_og_rmse_mlp.png}
                \caption*{\small Standard MSE trained model}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
