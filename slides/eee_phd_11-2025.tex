...
\begin{frame}{Accurate weather forecasts matter and that post-processing can work}
    ...
    \begin{itemize}
        ...
        \item CNNs can be used to correct NWP models on gridded data (Han et al. 2025). 
        \item NWP and ML models can be post-processed in similar process-based model (Trotta et al. 2025). 
    \end{itemize}
\end{frame}
...
\begin{frame}{How to Post-Process Weather Model Outputs? What Outputs Matter Most?}
    ...
    \begin{itemize}
        \item ML tools can be used to post-process models just as they have been used to build them. 
...
\begin{frame}{Post-processing is lessening systematic biases in forecasts}
...
\begin{frame}{Next Steps for Custom Loss Functions}
    \begin{itemize}
        \item Extend custom loss functionality to weight errors based on when they occur
...
\begin{frame}{How to estimate damage functions}
    \begin{itemize}
        \item Previously extended Roberts Schlenker 2009 style climate damage approach to estimate damage functions on corn yields in the US
        \item Using non-parametric quantile regression forest to estimate damage functions based on larger set of weather and agronomic variables
    \end{itemize}
    \begin{table}[htbp]
\centering
...
\begin{frame}{However, without irrigation, difficult to adapt to heat wave}
    \begin{itemize}
        ...
        \item Promising possibilities are precipitation at planting and harvesting, and late frosts during planting season.
    \end{itemize}
