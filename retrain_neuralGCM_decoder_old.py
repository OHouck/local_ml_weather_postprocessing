...
# can maybe help with debugging on GPUs, found on the jax docs
...
# not using currently but could be used for tacking an MLP onto the end of neuralGCM
class FineTuningMLP(nnx.Module):
    ...
    def __call__(self, x: jnp.ndarray) -> jnp.ndarray:
        """
        x (jax.numpy.ndarray): input tensor of shape (batch_size, input_dim)

        returns (jax.numpy.ndarray): output tensor of shape (batch_size, output_dim)
        """
